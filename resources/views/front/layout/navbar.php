 ...
 <div class="container">
         ...
         <div class="row flex-nowrap justify-content-between align-items-center">
             <div class="col-4 pt-1">
                 <?php if (session('locale') == 'ar'): ?>
                     <a class="link-secondary" href="<?php echo url('tasks/lang?lang=en'); ?>"><?php echo trans('main.english'); ?></a>
                 <?php else: ?>
                     <a class="link-secondary" href="<?php echo url('tasks/lang?lang=ar'); ?>"><?php echo trans('main.arabic'); ?></a>
                 <?php endif; ?>
             </div>
     ...
     <div class="nav-scroller py-1 mb-3">
         <nav class="nav nav-underline justify-content-between">
             <a class="nav-item nav-link link-body-emphasis {{empty(request('category_id')) ? ' active' : ''}}" href="{{ url('tasks') }}">{{ trans('main.home') }}</a>
             <?php
