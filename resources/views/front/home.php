...
<div class="row g-5">
 ...
 <div class="col-auto d-none d-lg-block">
          ...
          ?>
          <img src="{{ $img }}" class="bd-placeholder-img" style="width: 100px; height: 100;">
        </div>
              <div class="col-lg-8">
                <h6 class="mb-0">{{$news['title']}}</h6>
                <small class="text-body-secondary">{{ date('M d', strtotime($news['created_at'])) }}</small>
              </div>
            </a>
          </li>  
          <?php endwhile; ?>
