        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" placeholder="{{trans('news.title')}}" class="form-control{{ !empty(get_error('title')) ? ' is-invalid' : '' }}"
                        value="{{$news['title']}}" />
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" id="image" name="image" placeholder="{{trans('news.image')}}" class="form-control<?php echo !empty(get_error('image')) ? ' is-invalid' : ''; ?>" />
            ...
            <div class="col-md-24">
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="{{trans('news.description')}}" class="form-control<?php echo !empty(get_error('description')) ? ' is-invalid' : ''; ?>">{{ $news['description'] }}</textarea>
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="content">{{trans('news.content')}}</label>
                    <textarea name="content" id="content" placeholder="{{trans('news.content')}}" class="form-control<?php echo !empty(get_error('content')) ? ' is-invalid' : ''; ?>">{{ $news['content'] }}</textarea>
                </div>
            </div>
        </div>
