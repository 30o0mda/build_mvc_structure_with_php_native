        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" id="image" name="image" placeholder="{{trans('news.image')}}" class="form-control<?php echo !empty($image) ? ' is-invalid' : ''; ?>" />
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="description">{{trans('news.description')}}</label>
                    <textarea name="description" placeholder="{{trans('news.description')}}" class="form-control<?php echo !empty($description) ? ' is-invalid' : ''; ?>">{{old('description')}}</textarea>
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="content">{{trans('news.content')}}</label>
                    <textarea name="content" id="content" placeholder="{{trans('news.content')}}" class="form-control<?php echo !empty($content) ? ' is-invalid' : ''; ?>">{{old('content')}}</textarea>
                </div>
            </div>
        </div>
