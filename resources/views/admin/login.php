    ...
    <main class="form-signin w-100 m-auto">
        ...
        <form method="post" action="{{url(ADMIN.'/do/login')}}">
            ...
            <img
                ...
                width="72"
                height="57" />
            <h1 class="h4 mb-4 fw-normal">{{trans('admin.login_page')}}</h1>
            ...
            <div class="form-floating">
                ...
                <label for="floatingInput">{{ trans ('admin.password') }}</label>
            </div>
            <div
            ...
            <p class="mt-5 mb-3 text-body-secondary">&copy; 2017–2025
                ...
                <?php if (session('locale') == 'ar'): ?>
                    <a href="{{ url(ADMIN.'/lang?lang=en') }}" class="nav-link">{{ trans ('admin.english') }}</a>
                <?php else: ?>
                    <a href="{{ url(ADMIN.'/lang?lang=ar') }}" class="nav-link">{{ trans ('admin.arabic') }}</a>
                <?php endif; ?>
            </p>
        </form>
    </main>
