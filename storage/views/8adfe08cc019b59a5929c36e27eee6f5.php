    ...
    <div class="row">
        ...
        <div class="col-md-24">
            <div class="form-group">
                ...
                <textarea name="description" placeholder="<?php echo trans('news.description'); ?>" class="form-control<?php echo !empty(get_error('description')) ? ' is-invalid' : ''; ?>"><?php echo old('description'); ?></textarea>
            </div>
        </div>
        <div class="col-md-24">
            <div class="form-group">
                <label for="content"><?php echo trans('news.content'); ?></label>
                <textarea name="content" id="content" placeholder="<?php echo trans('news.content'); ?>" class="form-control<?php echo !empty(get_error('content')) ? ' is-invalid' : ''; ?>"><?php echo old('content'); ?></textarea>
            </div>
        </div>
    </div>
