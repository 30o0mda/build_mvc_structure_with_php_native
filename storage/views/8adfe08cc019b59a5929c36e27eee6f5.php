...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h2><?php echo  trans('admin.news') ; ?> - <?php echo  trans('admin.create_news') ; ?></h2>
    ...
    end_errors();
     ?>
    <form method="post" action="<?php echo aurl('news/store'); ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" id="image" name="image" placeholder="<?php echo trans('news.image'); ?>" class="form-control<?php echo !empty($image) ? ' is-invalid' : ''; ?>" />
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="description"><?php echo trans('news.description'); ?></label>
                    <textarea name="description" placeholder="<?php echo trans('news.description'); ?>" class="form-control<?php echo !empty($description) ? ' is-invalid' : ''; ?>"><?php echo old('description'); ?></textarea>
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="content"><?php echo trans('news.content'); ?></label>
                    <textarea name="content" id="content" placeholder="<?php echo trans('news.content'); ?>" class="form-control<?php echo !empty($content) ? ' is-invalid' : ''; ?>"><?php echo old('content'); ?></textarea>
                </div>
            </div>
        </div>
