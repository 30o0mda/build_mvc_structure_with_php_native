    ...
    <div
        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col"><?php echo  trans('category.name') ; ?></th>
                    <th scope="col"><?php echo  trans('category.icon') ; ?></th>
                    <th scope="col"><?php echo  trans('category.description') ; ?></th>
                    <th scope="col"><?php echo  trans('category.action') ; ?></th>
                </tr>
            </thead>
            <tbody>
