        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="<?php echo trans('user.name'); ?>" class="form-control<?php echo !empty($name) ? ' is-invalid' : ''; ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="email" placeholder="<?php echo trans('user.email'); ?>" class="form-control<?php echo !empty($email) ? ' is-invalid' : ''; ?>"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="password" name="password" placeholder="<?php echo trans('user.password'); ?>" class="form-control<?php echo !empty($password) ? ' is-invalid' : ''; ?>" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="mobile"><?php echo trans('user.mobile'); ?></label>
                    <input type="text" name="mobile" placeholder="<?php echo trans('user.mobile'); ?>" class="form-control<?php echo !empty($mobile) ? ' is-invalid' : ''; ?>"
