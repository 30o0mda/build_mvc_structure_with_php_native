...
?>
    <div
        ...
        <a class="btn btn-primary" href="<?php echo aurl('users/create'); ?>"><i class="fa-solid fa-plus"></i><?php echo  trans('user.create') ; ?></a>
    </div>
    <div
        ...
        <table class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th scope="col"><?php echo  trans('user.action') ; ?></th>
                </tr>
            </thead>
            <tbody>
                <?php while ($user = mysqli_fetch_assoc($users['query'])): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo aurl('users/edit?id='.$user['id']); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
