<?php if (!empty($url)):
    ...
    <!-- Modal -->
    <div class="modal fade" id="deleteform<?php echo $rand; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form method="post" action="<?php echo $url; ?>">
                        ...
                        <button type="submit" class="btn btn-danger"><?php echo  trans('admin.delete_confirmation') ; ?></button>
