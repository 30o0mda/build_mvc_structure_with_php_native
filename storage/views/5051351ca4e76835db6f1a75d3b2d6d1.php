        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" placeholder="<?php echo trans('news.title'); ?>" class="form-control<?php echo  !empty($title) ? ' is-invalid' : '' ; ?>"
            ...
            <div class="col-md-24">
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="<?php echo trans('news.description'); ?>" class="form-control<?php echo !empty($description) ? ' is-invalid' : ''; ?>"><?php echo  $news['description'] ; ?></textarea>
                </div>
            </div>
            <div class="col-md-24">
                <div class="form-group">
                    <label for="content"><?php echo trans('news.content'); ?></label>
                    <textarea name="content" id="content" placeholder="<?php echo trans('news.content'); ?>" class="form-control<?php echo !empty($content) ? ' is-invalid' : ''; ?>"><?php echo  $news['content'] ; ?></textarea>
                </div>
            </div>
        </div>
