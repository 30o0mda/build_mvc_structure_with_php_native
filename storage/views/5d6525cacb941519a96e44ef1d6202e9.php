...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <a class="btn btn-primary" href="<?php echo aurl('news/create'); ?>"><i class="fa-solid fa-plus"></i><?php echo  trans('admin.create_news') ; ?></a>
    </div>
    <div
                ...
                <?php while ($news = mysqli_fetch_assoc($news_list['query'])): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo aurl('news/edit?id='.$news['id']); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
